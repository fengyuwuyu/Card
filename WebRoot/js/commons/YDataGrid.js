...
var YDataGrid = function(config){
		...
		var showGridTitle = config.showGridTitle;
		...
		var initGrid = function(){
			...
			var pageList = dataGrid.pageList?dataGrid.pageList:[10,20,30,40,50];
			var dataconfig = {
				title:showGridTitle?dataGrid.title || '数据表格':null,
				...
				toolbar:showButton==false?[]:dataGrid.toolbar2 || getToolbar(),
