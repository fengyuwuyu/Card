...
YiYa.byUser = function(){
	var _this = {
			...
			init:function(){
				...
				$('.byUser').click(function(){$('#searchForm2').slideUp('slow',function(){$('#searchForm').slideDown('slow');});$('#listForm2').slideUp('slow',function(){$('#listForm').slideDown('slow',function(){$('#data-list').datagrid('reload');});});});
				$('.byDep').click(function(){$('#searchForm').slideUp('slow',function(){$('#searchForm2').slideDown('slow');});$('#listForm').slideUp('slow',function(){$('#listForm2').slideDown('slow',function(){$('#data-list2').treegrid('reload');});});});
				$('#byDoor').click(function(){
				...
				$('#bySite').click(function(){
					...
					if(rows && rows.length > 0){
						...
						$('#userSerials2').val(userSerials);
						$('#depSerials2').val('');
					}else{
						YiYa.alert('警告信息','未选中记录！','warning');
					}
				});
				$('#byDoor2').click(function(){
