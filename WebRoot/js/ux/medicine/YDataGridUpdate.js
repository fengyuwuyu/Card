		...
		var Handler = {
						...
						edit:function(callback){
						    $('#searchForm').form('submit', {    
						    	url : urls['msUrl'] + 'InventoryController/import.do',  
						...
						remove:function(callback){
							...
							$("#updateInventory").dialog("open");
							$("#medicineName").val(rows.medicineName);
							$("#mednicePrice").val(rows.price);	
							$('#quantity').numberbox('setValue', Number(rows.quantity));
							$('#updateinventoryId').val(rows.inventoryId);	
