	...
	var  type=$("#selectType").val(); 
		...
		var Handler = {
						...
						search:function(callback){
							if(type=='1'){
								$("#data-list").datagrid('hideColumn','userLname');
								$("#data-list").datagrid('hideColumn','userNo');
							//	$("#data-list").datagrid('hideColumn','cardNumber');
								$("#data-list").datagrid('hideColumn','amount');
							}else{
								$("#data-list").datagrid('showColumn','userLname');
								$("#data-list").datagrid('showColumn','userNo');
							//	$("#data-list").datagrid('showColumn','cardNumber');
								$("#data-list").datagrid('showColumn','amount');
							}
