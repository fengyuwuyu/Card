...
YiYa.rechargeRecord = function(){
	...
	var _this = {
		config:{
  			dataGrid:{
	   			url:urls['msUrl'] + 'PurchaseController/dataList1.do',
	   			idField:'medicineId',
	   			columns:[[
					...
					//	{field:'cardNumber',title:'医药账号',align:'center',width:150,sortable:true},
						{field:'price',title:'消费金额',align:'center',width:150,sortable:true},
						{field:'childMenus',title:'购买信息',align:'center',width:120,formatter:function(value,row,index){
