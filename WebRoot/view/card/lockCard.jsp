...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="../../js/ux/card/lockCard.js"></script>
	</head>
	<body>
		...
		<div class="easyui-panel warp" data-options="border:false" >
     		...
     		<div id="edit-win" class="easyui-dialog" title="挂失/解挂对话框" data-options="width:550,height:470,closed:true,iconCls:'icon-window',modal:true" buttons='#dlg-buttons'>  
     			<form id="editForm" class="ui-form" method="post">  
     		 	...
     		 	<div class="ui-edit">
	           		...
	           		<div class="ftitle part">挂失信息</div>	
	           		<div class="fitem part">  
	               		<label>挂失次数：</label>  
	               		<input id="cardLossCount" name="cardLossCount" class="easyui-validatebox ui-text" type="text" readonly >	               	
	           		</div>             			  		 
	           		<div class="fitem part">  
	               		<label>挂失原因：</label>  
	               		<textarea id="cardBz" name="cardBz" class="easyui-validatebox ui-text" data-options="validType:'length[0,50]'"></textarea>
	               		<span>不超过50字</span>	              
	           		</div> 		           		
	           		<div class="fitem part">  
	               		<label>提示信息：</label>  
	           		...
	           		<div class="ftitle part2">卡片操作信息</div>	   
  	 		...
  	 		<div id="dlg-buttons">
  	 			<a id="btn-lockCard" href="#" class="easyui-linkbutton">挂失</a>
  	 			<a id="btn-readCard" href="#" class="easyui-linkbutton">读卡</a>				
				<a id="btn-unlockCard" href="#" class="easyui-linkbutton">解挂</a>
