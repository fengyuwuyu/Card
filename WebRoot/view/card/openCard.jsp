...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="../../js/ux/card/openCard.js"></script>
	</head>
	<body>
     		...
     		<div id="edit-win" class="easyui-dialog" title="开卡对话框" data-options="width:550,height:470,closed:true,iconCls:'icon-window',modal:true" buttons='#dlg-buttons'>  
     			<form id="editForm" class="ui-form" method="post">  
     		 	...
     		 	<div class="ui-edit">
	           		...
	           		<div class="fitem">  
	           			<label>使用截止日期：</label>  
	               		<input name="deadline" id="deadline" class="easyui-datebox" data-options="editable:false"><span style="color:red;">（注：会在此日24点自动退卡）</span>
	           		</div> 	  
