...
<link href="${pageContext.request.contextPath}/js/ux/kq/calendar/images/base.css" rel="stylesheet"
	type="text/css" />
<link href="${pageContext.request.contextPath}/js/ux/kq/calendar/images/all.css" rel="stylesheet"
	type="text/css" />
<link href="${pageContext.request.contextPath}/js/ux/kq/calendar/images/skin.css" rel="stylesheet"
	type="text/css" />
<link href="${pageContext.request.contextPath}/js/ux/kq/calendar/images/fontSize12.css"
	rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/js/ux/kq/calendar/images/calendar.css"
	rel="stylesheet" type="text/css" />
<script type="text/javascript" src="${pageContext.request.contextPath}/js/ux/kq/calendar/calendar.js"></script>
</head>
