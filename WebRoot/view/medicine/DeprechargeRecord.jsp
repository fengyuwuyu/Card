...
<html>
  <head>
   ...
   <%@include file="../resource.jsp"%>  		
	<script type="text/javascript" src="../../js/ux/medicine/YTreeGridRecode.js"></script>
	<script type="text/javascript" src="../../js/ux/medicine/DeprechargeRecord.js"></script>
  </head>
   ...
   <div class="easyui-panel warp" data-options="border:false">
 	 		<div class="easyui-panel ui-search-panel" title="查询条件" data-options="striped: true,collapsible:true,iconCls:'icon-search',width:1100">  
        		...
        		<p class="ui-fields">
	        		...
	        		<input  id="selectType"  name="selectType" value="1" type="hidden">
     		...
     		<form id="listForm" method="post">
  	 		...
  	 		<div  id="userMessage" class="easyui-dialog" style="width:470px;height:450px" data-options="title:'充值信息',modal:true,closed:true,iconCls:'icon-window',buttons: [ {text: '关闭',   handler: function () { $('#userMessage').dialog('close'); }  }]">
			</div>
   </div>
  </body>
</html>
