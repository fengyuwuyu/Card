...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="../../js/ux/impower/byUser.js"></script>
	</head>
	<body>
		<div class="easyui-panel warp" data-options="border:false">
     		...
     		<form id="listForm" method="post">
				...
				<div id="menu-select" >
				    <div class="byUser" iconCls="icon-account">选员工（默认）</div>
				    <div class="menu-sep"></div>
				    <div class="byDep" iconCls="icon-org">选部门</div>
				</div>
				<div id="menu-impower" >
				    <div id="byDoor" iconCls="icon-door">选门</div>
				    <div class="menu-sep"></div>
				    <div id="bySite" iconCls="icon-home">选场所</div>
				</div>
     		</form>
     		...
     		<form id="listForm2" method="post">
				...
				<div id="menu-impower2" >
				    <div id="byDoor2" iconCls="icon-door">选门</div>
				    <div class="menu-sep"></div>
				    <div id="bySite2" iconCls="icon-home">选场所</div>
				</div>
     		</form>			
			

     		<div id="edit-win" class="easyui-dialog" title="授权对话框 -- 选门" data-options="width:800,height:450,closed:true,iconCls:'icon-window',modal:true,buttons:'#dlg-buttons'">   
     		 	<div class="ui-edit">   
	           		<form id="searchForm3" class="ui-form" method="post">
           			<div class="ftitle">门列表</div>      
  	 		...
  	 		<div id="edit-win2" class="easyui-dialog" title="授权对话框 -- 选场所" data-options="width:800,height:450,closed:true,iconCls:'icon-window',modal:true,buttons:'#dlg-buttons2'">   
     		 	<div class="ui-edit">  
	           		<form id="searchForm4" class="ui-form" method="post">
           			<div class="ftitle">场所列表</div>      
